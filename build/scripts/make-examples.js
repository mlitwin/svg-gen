...
const docsDir = path.resolve(__dirname, '../output/images');
...
fs.writeFileSync(`${docsDir}/spherestandard.svg`, parseToText(sphereStandard));
fs.writeFileSync(`${docsDir}/sphereskew.svg`, parseToText(sphereSkew));
...
fs.writeFileSync(`${docsDir}/spherestandard-tangent.svg`, parseToText(tangentStandard));

const tangentSkew = makeCoordSys({ x1: .75, y1: .25, x2: 1, y2: 1 });
fs.writeFileSync(`${docsDir}/sphereskew-tangent.svg`, parseToText(tangentSkew));
